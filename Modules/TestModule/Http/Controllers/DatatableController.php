...
//                dd($request->get("category"));
                ...
                $news->images = $image;
                return view('testmodule::imageDisplay', compact('news'));
            })
...
//                dd($news->display_content);
            ...
            ->addColumn('action', function (News $news) {
                return view('testmodule::actionNews', compact('news'));
            })
            ->addColumn('category', function (News $news) {
                $category = NewsCate::getCateName($news->news_id);
                $news->category = $category;
                return view('testmodule::cateDisplay', compact('news'));
            })
    ...
    public function cateDataTable(){
        ...
        return DataTables::of($categories)
            ->addColumn('action', function (Category $cate) {
                    return view('testmodule::actionCategory', compact('cate'));
            })
            ->rawColumns(['action'])
            ->make(true);
    }
