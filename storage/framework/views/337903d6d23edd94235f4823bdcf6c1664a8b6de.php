                    ...
                    <div class="card">
                        ...
                        <div class="">
                            <div class="panel-body row">
                                <form method="post" action="<?php echo e(route('news.store')); ?>" id="edit_form"
                                                ...
                                                <div class="box-header box-img-create">
                                                    ...
                                                    <div class="box-body pad">
                                                        <input type="file" required id="image"
                                                               class="form-control file_val image-create" name="image"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" name="cate[]"
                                                                           type="checkbox" id="<?php echo e($cate->id); ?>"
                                                                           value="<?php echo e($cate->cate_id); ?>" <?php echo e((is_array(old('cate')) && in_array($cate->cate_id, old('cate'))) ? ' checked' : ''); ?>> <?php echo e($cate->name); ?>
