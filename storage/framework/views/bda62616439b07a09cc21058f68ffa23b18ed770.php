        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('user.update',$user->id)); ?>" id="edit_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pl-1">
                                    <div class="form-group">
                                        ...
                                        <input name="postal_code" type="number" class="form-control" placeholder="ZIP Code" value="<?php echo e($user->postal_code); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="about_me" rows="4" cols="80" class="form-control about-me"
                                                  placeholder="Here can be your description"><?php echo e($user->about_me); ?></textarea>
                                    </div>
                                </div>
                            </div>
