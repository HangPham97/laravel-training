                                                ...
                                                <div class="col-md-8 left-bar">
                                                    <div class="box">
                                                        <div class="box-header">
                                                            ...
                                                            <span style="padding-left: 10px; font-weight: 800;font-size: 18px"><?php echo e($news->news_id); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="box">
                                                        <div class="box-header">
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <div class="box-body pad" style="">
                                                            ...
                                                            <textarea name="sample" rows="5" cols="80"
                                                                      ...
                                                                      placeholder="Here can be your description"><?php echo e($news->sample); ?></textarea>
                                                    ...
                                                    <div class="box">
                                                        <div class="box-header box-img">
                                                            ...
                                                            <div class="box-body pad">
                                                                ...
                                                                <img id="image-url"
                                                                     src="<?php echo e(\Modules\AdminModule\Entities\news::getDataUrl($news->image)); ?>"
